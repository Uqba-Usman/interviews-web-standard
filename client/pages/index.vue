<template>
    <div class="container">
      ...
      <!-- Modal for displaying and editing tags -->
      <div v-if="isModalOpen" class="modal-overlay">
        <div class="modal-content">
          <button class="close-modal" @click="closeTagsModal">×</button>
          <h4 class="modal-title">Manage Tags for Task: {{ selectedTask?.name }}</h4>
    ...
    methods: {
      ...
      fetchTags() {
        getTags()
          ...
          .catch(() => Swal.fire({ icon: "error", title: "Error fetching tags" }));
      },
      handleDelete(id) {
        Swal.fire({
          title: "Are you sure?",
